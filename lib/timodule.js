...
exports.find = function (modules, platforms, deployType, sdkVersion, searchPaths, logger, callback) {
	...
	exports.detect(searchPaths, logger, function (installed) {
		modules.forEach(function (module) {
			...
			logger && logger.debug(__('Looking for Titanium module id: %s version: %s platform: %s', module.id.cyan, originalVersion.cyan, (Array.isArray(module.platform) ? module.platform.join(',') : module.platform).cyan));
			...
			if (!found) {
				logger && logger.warn(__('Could not find Titanium module id: %s version: %s platform: %s', module.id.cyan, originalVersion.cyan, (Array.isArray(module.platform) ? module.platform.join(',') : module.platform).cyan));
