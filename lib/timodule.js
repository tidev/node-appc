	...
	exports.detect(searchPaths, logger, function (installed) {
		modules.forEach(function (module) {
			...
			if (!module.deployType || module.deployType == deployType) {
				...
				logger && logger.debug(__('Looking for Titanium module id=%s version=%s platform=%s deploy-type=%s', module.id.cyan, originalVersion.cyan, (Array.isArray(module.platform) ? module.platform.join(',') : module.platform).cyan, module.deployType.cyan));
			...
			if (!found) {
				logger && logger.warn(__('Could not find Titanium module id=%s version=%s platform=%s deploy-type=%s', module.id.cyan, originalVersion.cyan, (Array.isArray(module.platform) ? module.platform.join(',') : module.platform).cyan, module.deployType.cyan));
