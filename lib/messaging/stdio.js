...
module.exports.prototype = new Transport();

/**
 * @private
 */
module.exports.prototype.send = function (messageType, data, callback) {
	data = JSON.stringify({
		messageType: messageType,
		data: typeof data === 'undefined' ? null : data
	});
	var seqId = this._sequenceIDPrefix + (sequenceIDCount++),
