...
/**
 * Determines the most minimum value of the input version string.
 ...
 */
exports.parseMin = function (str) {
	var min;

	str.split(',').forEach(function (range) {
 ...
 * @returns {Boolean} True if the version matches one of the ranges
 */
exports.satisfies = function (ver, str) {
	return str.split(',').some(function (range) {
