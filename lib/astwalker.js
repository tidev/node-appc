...
// Event listeners is a dictionary, with the key being the rule name, and the value being the callback. You can also
// pass in '*' to recieve a callback for all rules. Returns true if the file was processed successfully, false otherwise
module.exports = function (filename, eventListeners) {
	...
	while (nodeStack.length) {
		...
		(eventListeners[name] && eventListeners[name](node)) || (eventListeners['*'] && eventListeners['*'](node));
