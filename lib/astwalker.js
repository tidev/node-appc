/**
 * Walks an Uglify 1.x AST tree and calls listeners when specific nodes are
 * visisted.
 *
 * @module astwalker
 *
 ...
 *
 * @method
 * @param {String|module:AST.node} astOrFilename - Filename The file to process or a pre-parsed AST tree
 * @param {Object|Function} eventListeners - An object containing the rules to listen
