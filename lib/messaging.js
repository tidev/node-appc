 ...
 *		}
 *
 *	messageType: always a string, and is the value of messageType supplied to {@link module:messaging/transport.listen} or {@link module:messaging/transport.send}
...
MessagingInterface.prototype.open = function () {
	this._transport = new require('messaging/' + this._transportType);
};
 ...
 * @param {module:messaging/transport~listenCallback} callback The callback to fire when a message arrives. The callback is passed
 ...
 * @param {module:messaging/transport~sendCallback} callback The callback to fire once the transmission is complete or
...
MessagingInterface.prototype.send = function (messageType, data, callback) {
	...
	this._transport.send(messageType, data, callback);
};